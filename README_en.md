...
Oh, a quick reminder: Idfk how to use this commit thing, so i'll use "Initial Commit" for the code updates and "Update" for changes in README, like news or reports. And pls ignore my english.